<template>
  ...
  >
    ...
    <template v-if="showFlag">
      ...
      >
        ...
        >
          ...
          >
            ...
            >
            <el-input
              v-model="searchForm.gongsimingcheng"
              placeholder="装修公司名称"
      ...
      >
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <div v-if="scope.row.gongsifengmian">
                <img
                  v-if="scope.row.gongsifengmian.substring(0, 4) == 'http'"
                  :src="scope.row.gongsifengmian.split(',')[0]"
                  width="100"
                  height="100"
                />
                <img
                  v-else
                  :src="$base.url + scope.row.gongsifengmian.split(',')[0]"
                  width="100"
                  height="100"
                />
              </div>
          ...
          >
            <template slot-scope="scope">
              <el-tag v-if="scope.row.sfsh == '否'" type="danger"
                >未通过</el-tag
              >
              <el-tag v-if="scope.row.sfsh == '待审核'" type="warning"
                >待审核</el-tag
              >
          ...
          <el-table-column width="300" label="操作">
            <template slot-scope="scope">
              ...
              <el-button
                class="btn8"
                v-if="isAuth('yuyuexinxi', '设计方案')"
                @click="
                  fangwushejiCrossAddOrUpdateHandler(
                    scope.row,
                    'cross',
                    '否',
                    '',
              ...
              <el-button
                class="edit"
                v-if="
                  isAuth('yuyuexinxi', '修改') && scope.row.sfsh == '待审核'
                "
                type="success"
                @click="addOrUpdateHandler(scope.row.id)"
              >
                <span
                  class="icon iconfont icon-xiugai11"
                  :style="{
                    margin: '0 2px',
                    fontSize: 'inherit',
                    color: 'inherit',
    ...
    <fangwusheji-cross-add-or-update
      v-if="fangwushejiCrossAddOrUpdateFlag"
      :parent="this"
      ref="fangwushejiCrossaddOrUpdate"
    ></fangwusheji-cross-add-or-update>
...
import fangwushejiCrossAddOrUpdate from "../fangwusheji/add-or-update";
export default {
  data() {
    return {
      searchForm: {
      ...
      fangwushejiCrossAddOrUpdateFlag: false,
  ...
  methods: {
    ...
    fangwushejiCrossAddOrUpdateHandler(
      ...
      this.fangwushejiCrossAddOrUpdateFlag = true;
      ...
      if (statusColumnName != "" && !statusColumnName.startsWith("[")) {
        ...
        for (var o in obj) {
          if (o == statusColumnName && obj[o] == statusColumnValue) {
            ...
            this.showFlag = true;
            this.fangwushejiCrossAddOrUpdateFlag = false;
            return;
          }
        }
      }
      this.$nextTick(() => {
        this.$refs.fangwushejiCrossaddOrUpdate.init(row.id, type);
      });
    },
    ...
    getDataList() {
      ...
      if (
        ...
        this.searchForm.gongsimingcheng != undefined
      ) {
