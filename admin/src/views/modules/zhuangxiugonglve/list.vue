    ...
    <template v-if="showFlag">
      ...
      >
        ...
        >
          <el-button
            class="add"
            v-if="isAuth('zhuangxiugonglve', '新增')"
            type="success"
          ...
          <el-button
            class="del"
            v-if="isAuth('zhuangxiugonglve', '删除')"
      ...
      >
        <el-table
          ...
          :border="true"
          v-if="isAuth('zhuangxiugonglve', '查看')"
          :data="dataList"
        ...
        >
          ...
          <el-table-column width="300" label="操作">
            <template slot-scope="scope">
              ...
              <el-button
                class="edit"
                v-if="isAuth('zhuangxiugonglve', '修改')"
                type="success"
...
export default {
  ...
  methods: {
    ...
    zhuangxiugonglvestatusChange(e, row) {
      if (row.status == 0) {
        row.passwordwrongnum = 0;
      }
      this.$http({
        url: "zhuangxiugonglve/update",
        method: "post",
        data: row,
      }).then((res) => {
        if (row.status == 1) {
