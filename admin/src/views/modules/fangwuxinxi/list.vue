      ...
      >
        ...
        >
          ...
          >
            ...
            >
            <el-input
              v-model="searchForm.fangwumingcheng"
              placeholder="房屋名称"
          ...
          >
            ...
            >
            <el-input
              v-model="searchForm.fangjianhao"
              placeholder="房间号"
              @keydown.enter.native="search()"
              clearable
            ></el-input>
          ...
          >
            <template slot-scope="scope">
              <div v-if="scope.row.fangwutupian">
                <img
                  v-if="scope.row.fangwutupian.substring(0, 4) == 'http'"
                  :src="scope.row.fangwutupian.split(',')[0]"
                  width="100"
                  height="100"
                />
                <img
                  v-else
                  :src="$base.url + scope.row.fangwutupian.split(',')[0]"
                  width="100"
                  height="100"
                />
              </div>
