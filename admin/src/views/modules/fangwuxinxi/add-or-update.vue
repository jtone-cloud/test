    ...
    >
      <template>
        ...
        <el-form-item
          ...
          class="upload"
          v-if="type != 'info' && !ro.fangwutupian"
          label="房屋图片"
          prop="fangwutupian"
        >
          <file-upload
        ...
        <el-form-item
          ...
          class="upload"
          v-else-if="ruleForm.fangwutupian"
          label="房屋图片"
          prop="fangwutupian"
        >
          <img
            v-if="ruleForm.fangwutupian.substring(0, 4) == 'http'"
            class="upload-img"
            style="margin-right: 20px"
            v-bind:key="index"
            :src="ruleForm.fangwutupian.split(',')[0]"
            width="100"
            height="100"
          />
          <img
            ...
            style="margin-right: 20px"
            v-bind:key="index"
            v-for="(item, index) in ruleForm.fangwutupian.split(',')"
            :src="$base.url + item"
            width="100"
            height="100"
          />
      ...
      <el-form-item
        ...
        v-else-if="ruleForm.fangwuxiangqing"
        label="房屋详情"
        prop="fangwuxiangqing"
      >
        <span
          ...
          v-html="ruleForm.fangwuxiangqing"
        ></span>
      </el-form-item>
      <el-form-item
        :style="{
  ...
  methods: {
    ...
    info(id) {
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.ruleForm.fangwuxiangqing = this.ruleForm.fangwuxiangqing.replace(
            reg,
    ...
    onSubmit() {
      if (this.ruleForm.fangwutupian != null) {
        this.ruleForm.fangwutupian = this.ruleForm.fangwutupian.replace(
