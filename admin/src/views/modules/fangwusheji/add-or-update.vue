    ...
    >
      <template>
        ...
        <el-form-item
          ...
          class="input"
          v-else-if="ruleForm.shejishijian"
          label="设计时间"
          prop="shejishijian"
        >
          <el-input
      ...
      <el-form-item
        ...
        v-else-if="ruleForm.shejifangan"
        label="设计方案"
        prop="shejifangan"
      >
        <span
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        ruanzhuang: [],
        yingzhuang: [],
        baojia: [{ validator: validateNumber, trigger: "blur" }],
        zhuangxiufengge: [],
        shejishijian: [],
        shejifangan: [],
        yezhuzhanghao: [],
    ...
    info(id) {
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.ruleForm.shejifangan = this.ruleForm.shejifangan.replace(
            reg,
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                if (data.data.total >= crossoptnum) {
                  ...
                  this.$http({
                    url: `fangwusheji/${!this.ruleForm.id ? "save" : "update"}`,
                    method: "post",
                    data: this.ruleForm,
                  }).then(({ data }) => {
                    if (data && data.code === 0) {
                      this.$message({
                        ...
                        onClose: () => {
                          ...
                          this.parent.fangwushejiCrossAddOrUpdateFlag = false;
                          this.parent.search();
