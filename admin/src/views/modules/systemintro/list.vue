          ...
          >
            <template slot-scope="scope">
              <div v-if="scope.row.picture1">
                <img
                  v-if="scope.row.picture1.substring(0, 4) == 'http'"
                  :src="scope.row.picture1.split(',')[0]"
                  width="100"
                  height="100"
                />
                <img
                  v-else
                  :src="$base.url + scope.row.picture1.split(',')[0]"
                  width="100"
                  height="100"
                />
              </div>
          ...
          >
            <template slot-scope="scope">
              <div v-if="scope.row.picture2">
                <img
                  v-if="scope.row.picture2.substring(0, 4) == 'http'"
                  :src="scope.row.picture2.split(',')[0]"
                  width="100"
                  height="100"
                />
                <img
                  v-else
                  :src="$base.url + scope.row.picture2.split(',')[0]"
                  width="100"
                  height="100"
                />
              </div>
          ...
          >
            <template slot-scope="scope">
              <div v-if="scope.row.picture3">
                <img
                  v-if="scope.row.picture3.substring(0, 4) == 'http'"
                  :src="scope.row.picture3.split(',')[0]"
                  width="100"
                  height="100"
                />
                <img
                  v-else
                  :src="$base.url + scope.row.picture3.split(',')[0]"
                  width="100"
                  height="100"
                />
              </div>
