    ...
    >
      <template>
        ...
        <el-form-item
          ...
          class="input"
          v-else-if="ruleForm.liuyanshijian"
          label="留言时间"
          prop="liuyanshijian"
        >
          <el-input
      ...
      <el-form-item
        ...
        v-else-if="ruleForm.liuyanneirong"
        label="留言内容"
        prop="liuyanneirong"
      >
        <span
    ...
    info(id) {
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.ruleForm.liuyanneirong = this.ruleForm.liuyanneirong.replace(
            reg,
