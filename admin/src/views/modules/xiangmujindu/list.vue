<template>
  ...
  >
        ...
        >
          ...
          <el-table-column width="300" label="操作">
            <template slot-scope="scope">
              ...
              <el-button
                class="btn8"
                v-if="isAuth('xiangmujindu', '评价')"
                @click="
                  pingjiaxinxiCrossAddOrUpdateHandler(
                    scope.row,
                    'cross',
                    '',
                    '',
    ...
    <pingjiaxinxi-cross-add-or-update
      v-if="pingjiaxinxiCrossAddOrUpdateFlag"
      :parent="this"
      ref="pingjiaxinxiCrossaddOrUpdate"
    ></pingjiaxinxi-cross-add-or-update>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    pingjiaxinxiCrossAddOrUpdateHandler(
      ...
      this.$storage.set("crossTable", "xiangmujindu");
    ...
    xiangmujindustatusChange(e, row) {
      if (row.status == 0) {
