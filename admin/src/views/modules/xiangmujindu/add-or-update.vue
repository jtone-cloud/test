    ...
    >
      <template>
        ...
        <el-form-item
          ...
          class="input"
          v-else-if="ruleForm.kaishishijian"
          label="开始时间"
          prop="kaishishijian"
        >
          <el-input
        ...
        <el-form-item
          ...
          class="input"
          v-else-if="ruleForm.jieshushijian"
          label="结束时间"
          prop="jieshushijian"
        >
          <el-input
      ...
      <el-form-item
        ...
        v-else-if="ruleForm.xiangmujindu"
        label="项目进度"
        prop="xiangmujindu"
      >
        <span
    ...
    info(id) {
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.ruleForm.xiangmujindu = this.ruleForm.xiangmujindu.replace(
            reg,
