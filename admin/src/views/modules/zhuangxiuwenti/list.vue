...
export default {
  ...
  methods: {
    ...
    shDialog(row) {
      ...
      if (row) {
        this.shForm = {
          ...
          fuzeren: row.fuzeren,
          gongsifengmian: row.gongsifengmian,
          lianxifangshi: row.lianxifangshi,
          kongjian: row.kongjian,
          ruanzhuang: row.ruanzhuang,
          yingzhuang: row.yingzhuang,
          baojia: row.baojia,
          zhuangxiufengge: row.zhuangxiufengge,
          tiwenshijian: row.tiwenshijian,
          zhuangxiuwenti: row.zhuangxiuwenti,
    ...
    zhuangxiuwentistatusChange(e, row) {
      if (row.status == 0) {
