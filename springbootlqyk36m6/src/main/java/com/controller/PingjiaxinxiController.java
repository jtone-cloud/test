...
public class PingjiaxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,PingjiaxinxiEntity pingjiaxinxi,
		...
		if(tableName.equals("gongsi")) {
			pingjiaxinxi.setGongsimingcheng((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yezhu")) {
			pingjiaxinxi.setYezhuzhanghao((String)request.getSession().getAttribute("username"));
		}
