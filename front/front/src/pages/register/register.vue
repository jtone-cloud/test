<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://localhost:8080/springbootlqyk36m6/upload/22.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
		...
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"width":"30vw","padding":"0px","margin":"0 0 0 50vw","borderRadius":"0px","background":"#fff","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"width":"80%","margin":"20px auto 10px","lineHeight":"44px","fontSize":"28px","color":"#333","textAlign":"left"}'>家居装修管理系统注册</p></div>
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='yezhu'" prop="yezhuzhanghao">
				<div v-if="true" :style='{"width":"100%","lineHeight":"36px","fontSize":"14px","color":"#333"}' :class="changeRules('yezhuzhanghao')?'required':''">业主账号：</div>
				<el-input v-model="registerForm.yezhuzhanghao"  placeholder="请输入业主账号" />
			</el-form-item>
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='yezhu'" prop="mima">
			...
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='yezhu'" prop="mima2">
			...
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='yezhu'" prop="yezhuxingming">
				<div v-if="true" :style='{"width":"100%","lineHeight":"36px","fontSize":"14px","color":"#333"}' :class="changeRules('yezhuxingming')?'required':''">业主姓名：</div>
				<el-input v-model="registerForm.yezhuxingming"  placeholder="请输入业主姓名" />
			</el-form-item>
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='yezhu'" prop="xingbie">
			...
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='yezhu'" prop="lianxifangshi">
			...
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='yezhu'" prop="touxiang">
			...
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='yezhu'" prop="pquestion">
			...
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='yezhu'" prop="panswer">
			...
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='gongsi'" prop="gongsimingcheng">
				<div v-if="true" :style='{"width":"100%","lineHeight":"36px","fontSize":"14px","color":"#333"}' :class="changeRules('gongsimingcheng')?'required':''">装修公司名称：</div>
				<el-input v-model="registerForm.gongsimingcheng"  placeholder="请输入装修公司名称" />
			</el-form-item>
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='gongsi'" prop="mima">
				<div v-if="true" :style='{"width":"100%","lineHeight":"36px","fontSize":"14px","color":"#333"}' :class="changeRules('mima')?'required':''">密码：</div>
				<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='gongsi'" prop="mima2">
				<div v-if="true" :style='{"width":"100%","lineHeight":"36px","fontSize":"14px","color":"#333"}' :class="changeRules('mima')?'required':''">确认密码：</div>
				<el-input v-model="registerForm.mima2" type="password" placeholder="请再次输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='gongsi'" prop="fuzeren">
				<div v-if="true" :style='{"width":"100%","lineHeight":"36px","fontSize":"14px","color":"#333"}' :class="changeRules('fuzeren')?'required':''">负责人：</div>
				<el-input v-model="registerForm.fuzeren"  placeholder="请输入负责人" />
			</el-form-item>
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='gongsi'" prop="gongsifengmian">
				<div v-if="true" :style='{"width":"100%","lineHeight":"36px","fontSize":"14px","color":"#333"}' :class="changeRules('gongsifengmian')?'required':''">装修公司封面：</div>
                <file-upload
					tip="点击上传装修公司封面"
					action="file/upload"
					:limit="1"
					:multiple="true"
					:fileUrls="registerForm.gongsifengmian?registerForm.gongsifengmian:''"
					@change="gongsigongsifengmianUploadChange"
				></file-upload>
			</el-form-item>
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='gongsi'" prop="lianxifangshi">
				<div v-if="true" :style='{"width":"100%","lineHeight":"36px","fontSize":"14px","color":"#333"}' :class="changeRules('lianxifangshi')?'required':''">联系方式：</div>
				<el-input v-model="registerForm.lianxifangshi"  placeholder="请输入联系方式" />
			</el-form-item>
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='gongsi'" prop="gongsiyouxiang">
				<div v-if="true" :style='{"width":"100%","lineHeight":"36px","fontSize":"14px","color":"#333"}' :class="changeRules('gongsiyouxiang')?'required':''">装修公司邮箱：</div>
				<el-input v-model="registerForm.gongsiyouxiang"  placeholder="请输入装修公司邮箱" />
			</el-form-item>
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='gongsi'" prop="gongsidizhi">
				<div v-if="true" :style='{"width":"100%","lineHeight":"36px","fontSize":"14px","color":"#333"}' :class="changeRules('gongsidizhi')?'required':''">装修公司地址：</div>
				<el-input v-model="registerForm.gongsidizhi"  placeholder="请输入装修公司地址" />
			</el-form-item>
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='gongsi'" prop="chuanglishijian">
				<div v-if="true" :style='{"width":"100%","lineHeight":"36px","fontSize":"14px","color":"#333"}' :class="changeRules('chuanglishijian')?'required':''">创立时间：</div>
                <el-date-picker
                    format="yyyy 年 MM 月 dd 日"
                    value-format="yyyy-MM-dd"
                    v-model="registerForm.chuanglishijian"
                    type="date"
                    placeholder="创立时间"
                ></el-date-picker>
			</el-form-item>
			<el-form-item :style='{"width":"auto","padding":"0","margin":"0 auto 15px 10%","background":"none","height":"auto"}' v-if="tableName=='gongsi'" prop="gongsijianjie">
				<div v-if="true" :style='{"width":"100%","lineHeight":"36px","fontSize":"14px","color":"#333"}' :class="changeRules('gongsijianjie')?'required':''">装修公司简介：</div>
			    <editor
			        :style='{"minHeight":"250px","border":"1px solid #eee","width":"auto","borderRadius":"4px","height":"auto","maxWidth":"400px"}'
			        v-model="registerForm.gongsijianjie" 
			        class="editor" 
			        action="file/upload">
			    </editor>
			</el-form-item>
...
export default {
		...
		if(this.$route.query.pageFlag=='register'){
			...
			if(this.tableName=='gongsi'){
				this.registerForm = {
					...
					gongsiyouxiang: '',
					gongsidizhi: '',
					chuanglishijian: this.getCurDate(),
					shejituandui: '',
					gongsijianjie: '',
					sfsh: '',
					shhf: '',
			...
			if ('yezhu' == this.tableName) {
				this.requiredRules.yezhuzhanghao = [{ required: true, message: '请输入业主账号', trigger: 'blur' }]
			}
			if ('yezhu' == this.tableName) {
				this.requiredRules.mima = [{ required: true, message: '请输入密码', trigger: 'blur' }]
			}
			if ('yezhu' == this.tableName) {
				this.requiredRules.yezhuxingming = [{ required: true, message: '请输入业主姓名', trigger: 'blur' }]
			}
			if ('gongsi' == this.tableName) {
				this.requiredRules.gongsimingcheng = [{ required: true, message: '请输入装修公司名称', trigger: 'blur' }]
			}
			if ('gongsi' == this.tableName) {
				this.requiredRules.mima = [{ required: true, message: '请输入密码', trigger: 'blur' }]
			}
    ...
    created() {
		...
		if(this.$route.query.pageFlag=='register'){
		  ...
		  if ('gongsi' == this.tableName) {
			this.rules.gongsiyouxiang = [{ required: true, validator: this.$validate.isEmail, trigger: 'blur' }];
		  }
			this.registerForm.chuanglishijian = this.getCurDate();
		  if ('gongsi' == this.tableName) {
    ...
    methods: {
      ...
      gongsigongsifengmianUploadChange(fileUrls) {
          this.registerForm.gongsifengmian = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");
      },
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            var url=this.tableName+"/register";
				if((!this.registerForm.yezhuzhanghao) && `yezhu` == this.tableName){
					this.$message.error(`业主账号不能为空`);
					return
				}
               if(`yezhu` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
                this.$message.error(`两次密码输入不一致`);
                return
               }
				if((!this.registerForm.mima) && `yezhu` == this.tableName){
					this.$message.error(`密码不能为空`);
					return
				}
				if((!this.registerForm.yezhuxingming) && `yezhu` == this.tableName){
					this.$message.error(`业主姓名不能为空`);
					return
				}
					if(`yezhu` == this.tableName && this.registerForm.lianxifangshi &&(!this.$validate.isMobile2(this.registerForm.lianxifangshi))){
			  ...
			  if(this.tableName=='gongsi'){
				...
				if((!this.registerForm.gongsimingcheng) && `gongsi` == this.tableName){
					this.$message.error(`装修公司名称不能为空`);
					return
				}
               if(`gongsi` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
                this.$message.error(`两次密码输入不一致`);
                return
               }
				if((!this.registerForm.mima) && `gongsi` == this.tableName){
					this.$message.error(`密码不能为空`);
					return
				}
					if(`gongsi` == this.tableName && this.registerForm.gongsiyouxiang &&(!this.$validate.isEmail2(this.registerForm.gongsiyouxiang))){
...
<style rel="stylesheet/scss" lang="scss" scoped>
	.container {
		position: relative;
		background: url(http://localhost:8080/springbootlqyk36m6/upload/22.jpg);
