    ...
    >
      ...
      >
        <el-form-item :style="{ margin: '0 10px' }">
          ...
          <el-input
            v-model="formSearch.yezhuzhanghao"
            placeholder="业主账号"
          ...
          >
            ...
            >
              <div :style="{ width: '50%', padding: '0', flex: '1' }">
                <div class="title">{{ item.yezhuxingming }}</div>
...
export default {
  ...
  methods: {
    ...
    getList(page, fenlei, ref = "") {
      ...
      let searchWhere = {};
      if (this.formSearch.yezhuzhanghao != "")
        searchWhere.yezhuzhanghao = "%" + this.formSearch.yezhuzhanghao + "%";
      if (this.formSearch.xingbie != "")
        searchWhere.xingbie = this.formSearch.xingbie;
      if (this.sortType) searchWhere.sort = this.sortType;
      if (this.sortOrder) searchWhere.order = this.sortOrder;
      this.$http
        .get(`yezhu/${this.centerType ? "page" : "list"}`, {
    ...
    toDetail(item) {
      ...
      this.$router.push({ path: "/index/yezhuDetail", query: params });
    },
