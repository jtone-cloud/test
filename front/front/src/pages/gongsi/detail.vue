        ...
        >
          ...
          >
            ...
            <el-button
              ...
              v-if="btnAuth('gongsi', '预约')"
              @click="onAcross('yuyuexinxi', '是', '', '', '')"
              type="warning"
              >预约</el-button
            >
            <el-button
...
export default {
  ...
  methods: {
    ...
    async onAcross(
      ...
      localStorage.setItem("crossTable", `gongsi`);
            ...
            if (res.data.code == 0 && res.data.data.list.length > 0) {
              ...
              this.$http.post("storeup/delete", delIds).then((res) => {
                if (res.data.code == 0) {
                  ...
                  this.detail.storeupnum--;
                  this.$http
                    .post("gongsi/update", this.detail)
                    .then((res) => {});
                  this.$message({
                    type: "success",
                    message: "取消成功!",
    ...
    // 删除
    delClick() {
      this.$confirm("是否删除此装修公司？")
        .then((_) => {
          this.$http.post("gongsi/delete", [this.detail.id]).then((res) => {
            if (res.data.code == 0) {
              this.$message({
                type: "success",
                message: "删除成功!",
