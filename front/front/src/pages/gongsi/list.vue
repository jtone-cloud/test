    ...
    >
      ...
      >
        <el-form-item :style="{ margin: '0 10px' }">
          ...
          <el-input
            v-model="formSearch.gongsimingcheng"
            placeholder="装修公司名称"
        ...
        <el-form-item :style="{ margin: '0 10px' }">
          ...
          <el-input
            v-model="formSearch.gongsidizhi"
            placeholder="装修公司地址"
            @keydown.enter.native="getList(1, curFenlei)"
            clearable
          ></el-input>
      ...
      >
        ...
        >
          ...
          ></span>
          <span :style="{ color: '#333', lineHeight: '40px', fontSize: '14px' }"
            >点击量</span
          >
        </el-button>
      </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <img
                @click.stop="imgPreView(item.gongsifengmian)"
                :style="{
                  width: '100%',
                  objectFit: 'cover',
                  display: 'block',
                ...
                v-if="
                  item.gongsifengmian &&
                  item.gongsifengmian.substr(0, 4) == 'http'
                "
            ...
            >
              ...
              <div class="desc">{{ item.shejituandui }}</div>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    getList(page, fenlei, ref = "") {
      ...
      let searchWhere = {};
      if (this.formSearch.gongsimingcheng != "")
        searchWhere.gongsimingcheng =
          "%" + this.formSearch.gongsimingcheng + "%";
      if (this.formSearch.gongsidizhi != "")
        searchWhere.gongsidizhi = "%" + this.formSearch.gongsidizhi + "%";
      if (!this.centerType) {
        params["sfsh"] = "是";
      }
      ...
      this.$http
        .get(`gongsi/${this.centerType ? "page" : "list"}`, {
