    ...
    >
      ...
      >
        <el-form-item :style="{ margin: '0 10px' }">
          ...
          <el-input
            v-model="formSearch.fangwumingcheng"
            placeholder="房屋名称"
        ...
        <el-form-item :style="{ margin: '0 10px' }">
          ...
          <el-input
            v-model="formSearch.fangjianhao"
            placeholder="房间号"
            @keydown.enter.native="getList(1, curFenlei)"
            clearable
          ></el-input>
        ...
        <el-button
          ...
          type="primary"
          @click="add('/index/fangwuxinxiAdd')"
          ><i
            v-if="true"
            :style="{ color: '#fff', margin: '0 10px 0 0', fontSize: '14px' }"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <img
                @click.stop="imgPreView(item.fangwutupian)"
                :style="{
                  width: '100%',
                  objectFit: 'cover',
                  display: 'block',
                ...
                v-if="
                  item.fangwutupian && item.fangwutupian.substr(0, 4) == 'http'
                "
                :src="item.fangwutupian.split(',')[0]"
                class="image"
              />
              <img
                @click.stop="
                  imgPreView(
                    baseUrl +
                      (item.fangwutupian ? item.fangwutupian.split(',')[0] : '')
                  )
                "
                :style="{
                  width: '100%',
            ...
            >
              <div :style="{ width: '50%', padding: '0', flex: '1' }">
                <div class="title">{{ item.fangwumingcheng }}</div>
                ...
                >
                  ...
                  <span class="text">{{ item.yezhuzhanghao }}</span>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    getList(page, fenlei, ref = "") {
      ...
      let searchWhere = {};
      if (this.formSearch.fangwumingcheng != "")
        searchWhere.fangwumingcheng =
          "%" + this.formSearch.fangwumingcheng + "%";
      if (this.formSearch.fangjianhao != "")
        searchWhere.fangjianhao = "%" + this.formSearch.fangjianhao + "%";
      if (this.sortType) searchWhere.sort = this.sortType;
      if (this.sortOrder) searchWhere.order = this.sortOrder;
      this.$http
        .get(`fangwuxinxi/${this.centerType ? "page" : "list"}`, {
