      ...
      >
        <div :style="{ width: '100%', display: 'flex', height: 'auto' }">
          ...
          <div
            ...
            :style="{ width: '50%', padding: '0 0 0 20px', height: 'auto' }"
          >
            <template v-for="(item, index) in newsList">
              ...
              >
                ...
                <div :style="{ flex: '1', height: '100%' }">
                  ...
                  <span
                    class="icon iconfont icon-jiantou37"
                    :style="{
                      lineHeight: '20px',
                      fontSize: '14px',
                      color: '#999',
        ...
        <div
          ...
          :style="{ width: '100%', margin: '20px 0 0 0', height: 'auto' }"
        >
          <template v-for="(item, index) in newsList">
            <div
              v-if="index > 4"
