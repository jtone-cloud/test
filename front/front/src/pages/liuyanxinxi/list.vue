    ...
    >
      ...
      >
        ...
        <el-form-item :style="{ margin: '0 10px' }">
          ...
          <el-input
            v-model="formSearch.yezhuxingming"
            placeholder="业主姓名"
            @keydown.enter.native="getList(1, curFenlei)"
            clearable
          ></el-input>
        ...
        <el-button
          ...
          type="primary"
          @click="add('/index/liuyanxinxiAdd')"
          ><i
            v-if="true"
            :style="{ color: '#fff', margin: '0 10px 0 0', fontSize: '14px' }"
...
export default {
  ...
  methods: {
    ...
    getList(page, fenlei, ref = "") {
      ...
      if (this.formSearch.yezhuxingming != "")
        searchWhere.yezhuxingming = "%" + this.formSearch.yezhuxingming + "%";
      if (!this.centerType) {
        params["sfsh"] = "是";
      }
      ...
      this.$http
        .get(`liuyanxinxi/${this.centerType ? "page" : "list"}`, {
    ...
    toDetail(item) {
      ...
      this.$router.push({ path: "/index/liuyanxinxiDetail", query: params });
    },
