    ...
    >
      ...
      >
        ...
        <el-button
          ...
          type="primary"
          @click="add('/index/xiangmujinduAdd')"
          ><i
            v-if="true"
            :style="{ color: '#fff', margin: '0 10px 0 0', fontSize: '14px' }"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <img
                @click.stop="imgPreView(item.tupian)"
                :style="{
                  width: '100%',
                  objectFit: 'cover',
                  display: 'block',
              ...
              <img
                @click.stop="
                  imgPreView(
                    baseUrl + (item.tupian ? item.tupian.split(',')[0] : '')
                  )
                "
                :style="{
                  width: '100%',
...
export default {
  ...
  methods: {
    ...
    getList(page, fenlei, ref = "") {
      ...
      this.$http
        .get(`xiangmujindu/${this.centerType ? "page" : "list"}`, {
    ...
    toDetail(item) {
      ...
      this.$router.push({ path: "/index/xiangmujinduDetail", query: params });
    },
