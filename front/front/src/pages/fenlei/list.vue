...
export default {
  ...
  methods: {
    ...
    getList(page, fenlei, ref = "") {
      ...
      let searchWhere = {};
      if (this.formSearch.fenlei != "")
        searchWhere.fenlei = "%" + this.formSearch.fenlei + "%";
      if (this.sortType) searchWhere.sort = this.sortType;
      if (this.sortOrder) searchWhere.order = this.sortOrder;
      this.$http
        .get(`fenlei/${this.centerType ? "page" : "list"}`, {
