    ...
    >
      ...
      >
        <div
          ...
          :plain="isPlain"
        >
          <div :style="{ color: 'inherit', width: '100%', fontSize: '14px' }">
            全部
          </div>
        </div>
        <div
      ...
      >
        ...
        >
        <el-button
          v-if="btnAuth('zhuangxiugonglve', '新增')"
          :style="{
            cursor: 'pointer',
            border: '0',
            padding: '0px 15px',
          ...
          type="primary"
          @click="add('/index/zhuangxiugonglveAdd')"
          ><i
            v-if="true"
            :style="{ color: '#fff', margin: '0 10px 0 0', fontSize: '14px' }"
...
export default {
  ...
  methods: {
    ...
    getList(page, fenlei, ref = "") {
      ...
      this.$http
        .get(`zhuangxiugonglve/${this.centerType ? "page" : "list"}`, {
    ...
    toDetail(item) {
      ...
      this.$router.push({
        path: "/index/zhuangxiugonglveDetail",
        query: params,
      });
    },
