...
export default {
  ...
  methods: {
    ...
    init(type) {
      ...
      this.$http
        .get("option/fenlei/fenlei", { emulateJSON: true })
        .then((res) => {
          if (res.data.code == 0) {
    ...
    info() {
      this.$http
        .get(`zhuangxiugonglve/detail/${this.$route.query.id}`, {
          emulateJSON: true,
        })
        .then((res) => {
          if (res.data.code == 0) {
